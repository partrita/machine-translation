---
engine: markdown
title: "파이썬 개발자를 위한 Swift 학습 가이드"
subtitle: "Python 개발자를 위한 실전 Swift 문법, 고급 기능 및 연습 문제"
author: "Taeyoon Kim"
date: "2026-02-21"
format:
  html:
...
## 20. 테스트 주도 개발 (Test-Driven Development)
...
## 21. Python과 Swift 연결하기 (PythonKit)
...
이 섹션에는 Swift 핵심 문법과 개념을 실습할 수 있는 전체 예제 코드가 포함되어 있습니다.
...
이 섹션에는 학습한 개념을 직접 코딩해볼 수 있는 연습 문제 코드가 포함되어 있습니다.
...
이 섹션에는 연습 문제에 대한 해답과 상세한 설명 코드가 포함되어 있습니다.
