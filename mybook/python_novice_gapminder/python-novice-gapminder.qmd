...
JupyterLab은 Anaconda 파이썬 배포판의 일부로 포함되어 있습니다. Anaconda 배포판을 아직 설치하지 않았다면, 설치 지침을 위해 [설정 안내](https://swcarpentry.github.io/python-novice-gapminder/setup.html)를 참고하세요.
...
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| *   별표 기호를 사용하면                  | -   별표 기호를 사용하면                            |
| *   다음과 같은 불릿 리스트가             | -   다음과 같은 불릿 리스트가                                     |
| *   작성됩니다.                       | -   작성됩니다.                   |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| 1.   숫자를 순서대로 나열하면               | 1.   숫자를 순서대로 나열하면                             |
| 2.   이렇게 자동으로 정렬된 번호 매기기     | 2.   이렇게 자동으로 정렬된 번호 매기기              |
| 3.   리스트가 생성됩니다.                 | 3.   리스트가 생성됩니다.                         |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| *  스페이스 띄어쓰기(indents)를 활용해 | - 스페이스 띄어쓰기(indents)를 활용해                 |
|   *  계층을 가지는 구조를 만들거나         |   - 계층을 가지는 구조를 만들거나                   |
|   *  하위 서브-블록 목록들로 묶이게        |   - 하위 서브-블록 목록들로 묶이게              |
| *  아니면 아예 형태를 구분하여             | - 아니면 아예 형태를 구분하여                         |
|   1. 각기 다른 하위 형태를 조합해          |   1. 각기 다른 하위 형태를 조합해                       |
|   1. 서브 리스트를 구성할 수도 있습니다   |   2. 서브 리스트를 구성할 수도 있습니다                    |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| # 큰 레벨-1 헤딩(Level-1 Heading)    | ## 큰 레벨-1 헤딩(Level-1 Heading)              |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| ## 한 단계 작은 레벨-2 헤딩 (etc.)     | ### 한 단계 작은 레벨-2 헤딩 (etc.)              |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| 단순 줄 띄움(Line breaks) 같은 경우       | 단순 줄 띄움(Line breaks) 같은 경우                 |
| 그다지 크게 티가 안 나게 렌더링됩니다.        | 그다지 크게 티가 안 나게 렌더링됩니다.                    |
|                                       |                                                |
| 하지만 빈 줄(Empty line)을 넣으면         | 하지만 빈 줄(Empty line)을 넣으면                    |
| 완전히 새로운 문단(paragraph)이 시작됩니다.| 완전히 새로운 문단(paragraph)이 시작됩니다.             |
| ```                                   |                                                |
+---------------------------------------+------------------------------------------------+
+---------------------------------------+------------------------------------------------+
| ```                                   | <p></p>                                        |
| [링크 생성](http://software-carpentry.org)| [링크 생성](https://software-carpentry.org)        |
| 은 이 `[...](...)` 형태 규칙으로 작성되거나 | 은 이 `[...](...)` 형태 규칙으로 작성되거나          |
| [참조 앵커 방식의 링크][data-carp]도 가능.  | [참조 앵커 방식의 링크][data_carpentry]도 가능.    |
|                                       |                                                |
